...
function removeCSS() {
	...
	injectedStylesheets = [];
	console.log("WebTeX: Stylesheets removed");
}
	...
	chrome.runtime.onMessage.addListener((msg, _sender, sendResponse) => {
		...
		if (msg.action === "domain-updated" && msg.allowed) {
			...
			if (newIsEnabled && !isEnabled) {
				...
				isEnabled = false;
				disableRendering();
				console.log("WebTeX: Disabled rendering");
			}
...
function disableRendering() {
	...
	console.log("WebTeX: Rendering disabled, DOM and styles completely restored");
}
